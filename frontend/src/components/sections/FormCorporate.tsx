...
export default function FormCorporate() {
    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          formType: formData.get("formType"), // Parcerias Corporativas
        }),
        headers: {
    ...
    >
      <div className="relative z-10 w-full max-w-5xl">
        ...
        <div className="text-center mb-16">
          <Badge text="Parcerias Corporativas" bgColor="bg-cyan-600/20" textColor="text-cyan-700" />
          <h2 className="text-4xl font-bold text-gray-900">Vamos Crescer Juntos!</h2>
          <p className="mt-2 text-gray-700 max-w-2xl mx-auto">
            Sua empresa quer colaborar com o Instituto e gerar impacto social? Preencha o formulário e entre em contato!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl w-full items-stretch content-stretch min-h-[500px]">
          ...
          <div className="bg-white shadow-md rounded-xl p-4 md:p-8 border border-gray-200 flex flex-col justify-between h-full">
            <form onSubmit={onSubmit} className="flex flex-col gap-5 h-full">
              <input type="hidden" name="formType" value="Parceria Corporativa" />
              ...
              <div>
                ...
                <input
                  type="text"
                  name="subject"
                  placeholder="Como deseja colaborar conosco?"
                  className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-emerald-600 focus:outline-none text-gray-400 transition ease-in-out"
                />
              </div>
              ...
              <div className="max-h-20">
                ...
                <textarea
                  rows={5}
                  name="message"
                  placeholder="Conte mais sobre sua empresa e proposta..."
              ...
              {result && (
                ...
                >
                  {result === "Success!"
                    ...
                    : "Ops! Ocorreu um erro ao enviar a proposta. Tente novamente."}
                </p>
              )}
            </form>
          </div>
