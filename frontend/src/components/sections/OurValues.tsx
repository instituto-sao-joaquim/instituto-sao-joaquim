    ...
    >
      ...
      <div className="relative z-10 py-15 max-w-5xl text-center">
        <div className="text-center mb-16">
          <Badge text="Nossos Valores" bgColor='bg-brand-orange/20' textColor='text-dark-orange' />
        ...
        <div className="flex flex-col justify-center gap-6 mb-16">
          <div className="flex flex-col md:flex-row justify-center items-stretch gap-6">
            <Card
              icon={<FaHandHoldingHeart className="w-12 h-12 fill-dark-green" />}
            ...
            />
            <Card
              icon={<FaHandsHelping className="w-12 h-12 fill-dark-orange" />}
              title="Solidariedade"
            ...
            />
            <Card
              icon={<FaSeedling className="w-12 h-12 fill-dark-blue" />}
          ...
          <div className="flex flex-col md:flex-row justify-center items-stretch gap-6">
            <Card
              icon={<FaPeopleCarry className="w-12 h-12 fill-dark-green" />}
            ...
            />
            <Card
              icon={<FaShieldAlt className="w-12 h-12 fill-dark-orange" />}
              title="Transparência"
        ...
        >
          ...
          <div>
            <div className="inline-flex flex-row items-center justify-center bg-brand-red/10 backdrop-blur-md text-brand-red px-2 md:px-4 py-1.5 rounded-full text-xs font-medium shadow-md mb-4">
              Em Andamento
            </div>
            <div className='flex flex-col md:flex-row gap-6'>
              <div className="bg-white backdrop-blur-md rounded-lg p-6 flex flex-col items-center gap-2 text-left shadow-md flex-1 lg:max-w-60">
                <div className='flex items-center justify-center w-15 h-15 rounded-full bg-dark-green'>
              ...
              <div className="bg-white backdrop-blur-md rounded-lg p-6 flex flex-col items-center gap-2 text-left shadow-md flex-1 lg:max-w-60">
                <div className='flex items-center justify-center w-15 h-15 rounded-full bg-dark-orange'>
